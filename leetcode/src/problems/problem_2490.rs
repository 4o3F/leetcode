...
struct Solution {}
pub fn run() {
    tracing::info!("{}", Solution::is_circular_sentence("leetcode exercises sound delightful".to_string()));
    tracing::info!("{}", Solution::is_circular_sentence("eetcode".to_string()));
    tracing::info!("{}", Solution::is_circular_sentence("Leetcode is cool".to_string()));
}
