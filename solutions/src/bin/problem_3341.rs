...
impl Solution {
    pub fn min_time_to_reach(move_time: Vec<Vec<i32>>) -> i32 {
        ...
        while let Some((Reverse(current_time), current_row, current_col)) = heap.pop() {
            ...
            for direction in directions {
                ...
                heap.push((
                    Reverse(current_time.max(move_time[new_row as usize][new_col as usize]) + 1),
                    new_row,
                    new_col,
                ));
            }
